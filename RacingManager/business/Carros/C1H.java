...
public class C1H extends C1 implements Hibrido {
    ...
    public C1H(String idCarro, String marca, String modelo, String modoMotor, int cilindrada, int potencia, boolean serHibrido, float fiabilidade, Class classe, float pac, int eletrico, Equipa e){
